...
Route::prefix('api')->middleware(['webapi'])->group(function () {
    ...
    // 资产管理
    Route::any('assets/{method}',                   AssetsController::class);
    Route::any('assets/{method}/{action}',          AssetsController::class);
    Route::any('assets/{method}/{action}/{child}',  AssetsController::class);
    // 测试
